...
const REDIRECT_URL = 'https://seusite.com'; // URL do seu site principal
const GA_ID = 'G-XXXXXX'; // Seu ID do Google Analytics
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Verificar se já preencheu (opcional)
  if (localStorage.getItem('ozoxx_access')) {
    // Se já acessou antes, redireciona direto
  ...
  form.addEventListener('submit', async function(e) {
    ...
    try {
      ...
      if (result.success) {
        ...
        saveMetrics('complete'); // Métricas locais
...
function setupFormTracking(form) {
  ...
  // Contar abandono (usuário sai sem enviar)
...
// ENVIAR MÉTRICAS PARA SHEETS (separado)
function sendMetricsToSheets(metrics) {
  ...
  }).catch(e => console.log('Erro métricas:', e));
}
